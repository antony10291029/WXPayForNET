    ...
    public partial class ProductPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    ViewState["openid"] = "oe7f_tm82rPAeEdkFGigDtAj0t64";// "oe7f_tm82rPAeEdkFGigDtAj0t64";//jsApiPay.openid; // oe7f_tm82rPAeEdkFGigDtAj0t64
                }
                catch (Exception ex)
                {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["openid"] != null)
            {
                ...
                string url = "http://hshop.wochu.cn/wxpaytest/example/JsApiPayPage.aspx?openid=" + openid + "&total_fee=" + total_fee;
