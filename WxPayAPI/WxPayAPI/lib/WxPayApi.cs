    ...
    public class WxPayApi
    {
        ...
        */
        ...
        public static string GetIP()
        {
            ...
            try
            {
                if (requst.ServerVariables["HTTP_VIA"] != null)
                {
                    ip = requst.ServerVariables["HTTP_X_FORWARDED_FOR"].ToString();
                }
                else
                {

                    ip = requst.ServerVariables["REMOTE_ADDR"].ToString();
                }
                if (ip == string.Empty)
                {
                    ip = requst.UserHostAddress;
                }
                return ip;
            }
            catch
