    ...
    public class WxPayData
    {
        ...
        **/
        public string ToXml()
        {
            ...
            if (m_values["sign"] != null)
            {
                xml += "<sign>" + m_values["sign"] + "</sign>";
            }
            xml += "</xml>";
            return xml;
        }
        ...
        */
        public string MakeSign()
        {
            ...
            System.IO.File.AppendAllText(System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "log.txt"), DateTime.Now.ToString() + "：key = " + str + Environment.NewLine);
            //MD5加密
            var md5 = MD5.Create();
